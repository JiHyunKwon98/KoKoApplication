...
class CalendarAdapter(
    ...
    inner class ViewHolder(itemView: View, val listener: OnItemClickListener): RecyclerView.ViewHolder(itemView) {
        ...
        var linearLayout = itemView.findViewById<TextView>(R.id.calendar_linear_layout)
    }
    ...
    private fun makeItemDisabled(holder: ViewHolder) {
        holder.txtDay!!.setTextColor(ContextCompat.getColor(context, R.color.calendar_day_normal_font))
        holder.txtDayInWeek!!.setTextColor(ContextCompat.getColor(context, R.color.calendar_day_normal_font))
    ...
    private fun makeItemSelected(holder: ViewHolder) {
        ...
        holder.linearLayout!!.setBackgroundColor(ContextCompat.getColor(context, R.color.calendar_day_button_bg))
        holder.linearLayout!!.isEnabled = false
    }
